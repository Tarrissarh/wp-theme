...
class acf_field_cf7 extends acf_field
{
	...
	*/
	function create_field($field)
	{
		...
		//$field['class'] = str_replace('search', replace, subject)
	...
	*/
    /*function input_admin_enqueue_scripts()
    {
        ...
        wp_register_script( 'acf-input-cf7', $this->settings['dir'] . 'js/input.js', ['acf-input'], $this->settings['version'] );
        wp_register_style( 'acf-input-cf7', $this->settings['dir'] . 'css/input.css', ['acf-input'], $this->settings['version'] );
